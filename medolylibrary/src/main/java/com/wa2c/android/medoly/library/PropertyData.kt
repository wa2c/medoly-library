...
open class PropertyData : ExtraData {
     ...
     */
    operator fun get(key: IProperty?): List<String?>? {
     ...
     */
    fun put(key: IProperty?, value: MutableList<String?>?): List<String?>? {
     ...
     */
    fun put(key: IProperty?, value: String?): List<String?>? {
        return super.put(key?.keyName, value)
    }
     ...
     */
    fun remove(key: IProperty?): List<String?>? {
     ...
     */
    fun equals(property: IProperty?, list: List<String?>?): Boolean {
